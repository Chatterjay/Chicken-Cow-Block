...
ModernMekMachineEvents.registerChemicalRecipeTypes(event => {
  ...
  const shape = event.layeredShape("white_casing", [
    ...
    ["aiiiiiiiiiiiiiia", "bkkkkkkkkkkkkkkb", "a              a", "d              d", "d              d", "d              d", "a              a", "ejjjjjjjjjjjjjje", "a              a", "d              d", "d              d", "d              d", "b              b", "f              f", "gkkkkkkkkkkkkkkg", "hghbbbbbbbbbbhgh"],
    ["aiiiiiiiiiiiiiia", "bllllllllllllllb", "a              a", "d              d", "d              d", "d              d", "a              a", "ejjjjjjjjjjjjjje", "a              a", "d              d", "d              d", "d              d", "b              b", "f              f", "gllllllllllllllg", "hghbbbbbmbbbbhgh"],
    ["aiiiiiiiiiiiiiia", "bllllllllllllllb", "a              a", "d              d", "d              d", "d              d", "a              a", "ejjjjjjjjjjjjjje", "a              a", "d              d", "d              d", "d              d", "b              b", "f              f", "gllllllllllllllg", "hghbbbmbmbbbbhgh"],
    ["aiiiiiiiiiiiiiia", "bllllllllllllllb", "a              a", "d              d", "d              d", "d              d", "a              a", "ejjjjjjjjjjjjjje", "a              a", "d              d", "d              d", "d              d", "b              b", "f              f", "gllllllllllllllg", "hghbbbmmmmmbbhgh"],
    ["aiiiiiiiiiiiiiia", "bllllllllllllllb", "a              a", "d              d", "d              d", "d              d", "a              a", "ejjjjjjjjjjjjjje", "a              a", "d              d", "d              d", "d              d", "b              b", "f              f", "gllllllllllllllg", "hghbbmbbmbbbbhgh"],
    ["aiiiiiiiiiiiiiia", "bllllllllllllllb", "a              a", "a              a", "a              a", "a              a", "a              a", "ejjjjjjjjjjjjjje", "a              a", "b              b", "b              b", "b              b", "b              b", "f              f", "gllllllllllllllg", "hghbbbbbmbbbbhgh"],
    ["aiiiiiiiiiiiiiia", "bkkkkkkkkkkkkkkb", "a              a", "e              e", "e              e", "e              e", "e              e", "ejjjjjjjjjjjjjje", "a              a", "f              f", "f              f", "f              f", "f              f", "f              f", "gkkkkkkkkkkkkkkg", "hghbbbmmmmmbbhgh"],
    ["aiiiiiiiiiiiiiia", "b              b", "a              a", "n              n", "a              a", "n              n", "a              a", "njjjjjjjjjjjjjjn", "a              a", "n              n", "a              a", "n              n", "a              a", "f              f", "g              g", "hghbbbbbmbbbbhgh"],
    ["aiiiiiiiiiiiiiia", "b              b", "o              a", "p              p", "o              o", "p              p", "o              o", "pjjjjjjjjjjjjjjp", "o              o", "p              p", "o              o", "p              p", "o              o", "f              f", "g              g", "hghbbbbbmbbbbhgh"],
  ...
  .key("l", event.memberOfBlock("glassential:glass_lava_lamp"), event.noHatch())
  .key("m", event.memberOfBlock("mekanism:block_osmium"), event.noHatch())
